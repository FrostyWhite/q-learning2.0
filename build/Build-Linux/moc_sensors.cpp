...
void Sensors::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Sensors *_t = static_cast<Sensors *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Sensors::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_Sensors.data,
      qt_meta_data_Sensors,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
